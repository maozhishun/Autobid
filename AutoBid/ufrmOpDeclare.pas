...
begin
  ...
  self.edtCustomAddPriceBegin.Text :=  IntToStr(g_ScreanPointSetting.FCustomAddPriceLeftTop.X) +','+ IntToStr( g_ScreanPointSetting.FCustomAddPriceLeftTop.y);
  self.edtCustomAddPriceEnd.Text :=  IntToStr(g_ScreanPointSetting.FCustomAddPriceRightBottom.X) +','+ IntToStr( g_ScreanPointSetting.FCustomAddPriceRightBottom.y);
end;
